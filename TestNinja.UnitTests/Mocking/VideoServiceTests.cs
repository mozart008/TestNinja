...
namespace TestNinja.UnitTests.Mocking
{
    ...
    public class VideoServiceTests
    {
        ...
        {
            _videoRepository.Setup((vc) => vc.GetUnprocessedVideos()).Returns(new List<Video>());
        ...
        [Test]
        public void GetUnprocessedVideosAsCsv_SomeUnprocessedVideos_ReturnCommaSeparatedInt()
        {
            ...
            _videoRepository.Setup((vc) => vc.GetUnprocessedVideos()).Returns(videos);
